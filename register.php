...
<?php include_once './php/includes/navbar.php'; ?>
    ...
    <div class="container mt-5">
            <div class="row">
                <div class="col-12">
                    <div class="card-header text-light" style="background-color: #1e281e"><h4>Inscription</h4></div>
                    <div class="card-body">
                        <form method='post' action="">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <button type="submit" name="register" class="form-control btn text-light">S'inscrire</button>
                                    </div>
                                </div>
                            </div>
                        </form>
